...
public class UpgradedLabTest implements AddHealthCareProvider<LabTestPlusHealthCare> {
    List<LabTestPlusHealthCare> upgradedList;

    public UpgradedLabTest() {
        this.upgradedList = new LinkedList<>();
    }
    ...
    @Override
    public List<LabTestPlusHealthCare> addHealthCareProvider(List<LabTest> list) {

        for (LabTest labTest: list) {
            LabTestPlusHealthCare extra = getLabTestPlusHealthCare(labTest);
            this.upgradedList.add(extra);
        }
        return this.upgradedList;
    }
